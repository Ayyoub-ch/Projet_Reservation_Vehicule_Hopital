...
- Les vérifier et les faire valider
- La possibilité des les afficher 
...
- Voir les réservations affiliées à la personne connectée
- Quitter le menu
...
- Modifier une réservation
- Voir les réservations affiliées à la personne connectée
- Voir toutes les réservations existantes de la base de données
- Valider une ou plusieurs réservations
- Refuser une ou plusieurs réservations
- Quitter le menu
